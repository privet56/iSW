...
{
	// just some decent defaults so a naked emitter will do something.
...
-(void)emitNewParticles
{
	...
	//NSLog(@"emrange: start:%3.2f len:%3.2f",emissionRange.start, emissionRange.length);
}
